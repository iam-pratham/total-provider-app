...
export default function CptAnalysisPage() {
  ...
  const totalCptUsages = useMemo(
    () => cptStats.reduce((acc, curr) => acc + curr.total, 0),
    [cptStats],
  );
      ...
      >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold">
                {cptStats.length.toLocaleString()}
              </div>
              <p className="text-xs text-muted-foreground mt-1">
                Distinct procedure codes
              </p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          <Card className="flex flex-col">
            <CardHeader>
              ...
              <CardDescription>
                All {cptStats.length} CPT codes sorted by total usage
              </CardDescription>
            </CardHeader>
